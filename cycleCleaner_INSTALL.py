...
def onMayaDroppedPythonFile(*args):
    ...
    button_label = "Walk Cycle Cleaner"
    tooltip = "Launches the Walk Cycle Cleaner."
    icon_name = "CycleCleanerIcon.png"  # Your custom icon file name.
    ...
    cmd = 'import cycleCleaner.cycleCleaner as cc; cc.CycleCleaner()'
